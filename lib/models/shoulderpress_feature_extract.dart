...
class ShoulderPressFeatures {
  ...
  static List<double>? computeFeatures(Pose pose) {
    ...
    if (kDebugMode) {
      ...
      print('╠════════════════════════════════════════════════════════╣');
      print(
        '║  1. left_elbow_angle:          ${leftElbowAngle.toStringAsFixed(2).padLeft(7)}°  ║',
      );
      print(
        '║  2. right_elbow_angle:         ${rightElbowAngle.toStringAsFixed(2).padLeft(7)}°  ║',
      );
      print(
        '║  3. shoulder_width:            ${shoulderWidth.toStringAsFixed(4).padLeft(7)}   ║',
      );
      print(
        '║  4. wrist_shoulder_diff_left:  ${wristShoulderDiffLeft.toStringAsFixed(4).padLeft(7)}   ║',
      );
      print(
        '║  5. wrist_shoulder_diff_right: ${wristShoulderDiffRight.toStringAsFixed(4).padLeft(7)}   ║',
      );
      print(
        '║  6. trunk_angle:               ${trunkAngle.toStringAsFixed(2).padLeft(7)}°  ║',
      );
      print(
        '║  7. elbow_angle_diff:          ${elbowAngleDiff.toStringAsFixed(2).padLeft(7)}°  ║',
      );
      print('╚════════════════════════════════════════════════════════╝');
    }
